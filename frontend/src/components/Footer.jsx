...
const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal bg-black text-base-content p-10 animate-fadeIn">
      <aside>
        <svg
          width="50"
          height="50"
        ...
        <p className="text-md">Lucena City Bed and Breakfast</p>
      </aside>
      <nav>
        <h6 className="footer-title">Quick Links</h6>
        <a className="link link-hover">Home</a>
        <a className="link link-hover">About</a>
        <a className="link link-hover">Recommendation</a>
        <a className="link link-hover">Live Map</a>
