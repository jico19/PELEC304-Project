...
from .models import CustomUser, Room, Notification, ActiveRent, Reports, RentTransaction, RentPaymentHistory, LandlordApplication
...
admin.site.register(LandlordApplication)